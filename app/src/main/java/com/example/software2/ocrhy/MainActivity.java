        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    if (firstTime == 0)
                        textToSpeech.speak("Welcome. Swipe left to listen the features of the app and swipe right and say what you want", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if (mVoiceInputTv.getText().toString().equals("read")) {
                    ...
                    textToSpeech.speak("I did not understand, Swipe right and Say again", TextToSpeech.QUEUE_FLUSH, null);
                ...
                if (mVoiceInputTv.getText().toString().equals("yes")) {
                    textToSpeech.speak("  Say Read for reading,  calculator for calculator,  time and date,  weather for weather,  battery for battery, currency for currency detector. Do you want to listen again", TextToSpeech.QUEUE_FLUSH, null);
                    mVoiceInputTv.setText(null);
